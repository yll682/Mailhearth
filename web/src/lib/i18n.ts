...
const zh: Record<string, string> = {
  ...
  "This is your sign-in address; it can be an address on your domain.": "这是你的登录地址，可以是你域名下的邮箱地址。",
  "Create organisation": "创建组织", "Purelymail API token": "Purelymail API 令牌",
  "Create an API token in the Purelymail account portal (Account → API). It is stored encrypted on this server and never sent to browsers.":
    "在 Purelymail 管理后台（Account → API）创建 API 令牌。它会在本服务器上加密保存，绝不会发送到浏览器。",
  "Checking…": "校验中…", "Found on your Purelymail account": "在你的 Purelymail 账户中发现", "domains": "个域名", "mailboxes": "个邮箱",
  "routing rules": "条路由规则", "credit": "余额",
  "Importing builds the organisation model from what already exists. Nothing on Purelymail is changed.": "导入会基于现有内容建立组织模型，不会改动 Purelymail 上的任何数据。",
  "Connect my own mailbox": "连接我自己的邮箱", "Choose the mailbox you use so you can read mail right away.": "选择你使用的邮箱，导入后即可直接收发邮件。",
  ...
  "Search mail… try from:, subject:, is:unread, has:attachment": "搜索邮件… 可用 from:、subject:、is:unread、has:attachment",
  ...
  "Rules are stored on the mail server (Sieve) and run before mail reaches your inbox.": "规则以 Sieve 形式保存在邮件服务器上，在邮件进入收件箱前执行。",
  "Saving these rules replaces any filters configured in other mail clients for this mailbox.": "保存后会替换此邮箱在其他客户端配置的过滤器。",
  "Rules saved and installed on the server.": "规则已保存并安装到服务器。", "Rules saved.": "规则已保存。", "Auto-reply subject": "自动回复主题",
  "Auto-reply message": "自动回复内容", "Reply at most once every {n} days to the same sender": "对同一发件人最多每 {n} 天回复一次",
  ...
  "Make default": "设为默认", "Sender identity saved.": "发件身份已保存。", "Choose which address you send from and the signature that goes with it.": "选择发信使用的地址以及对应的签名。",
  ...
  "Offboard {name}": "为 {name} 办理离职", "Decide what happens to each mailbox. Access for {name} ends immediately and all credentials are rotated.":
    "决定每个邮箱的去向。{name} 的访问权限将立即终止，所有凭据都会轮换。",
  ...
  "This sets a new Purelymail password for use in other mail apps. It is shown once.": "这会为其他邮件客户端设置一个新的 Purelymail 密码，只显示一次。",
  "Password for external clients": "外部客户端密码", "IMAP server": "IMAP 服务器", "SMTP server": "SMTP 服务器", "Username": "用户名",
  "Suspending locks everyone out. Mail keeps arriving and is kept.": "挂起后所有人都无法访问，但邮件仍会继续接收并保留。",
  "Type the address to confirm": "输入地址以确认", "Deleting removes the mailbox and all its mail from Purelymail. This cannot be undone.":
    "删除会从 Purelymail 移除该邮箱及其全部邮件，且无法恢复。",
  "Grant access": "授予访问权限", "Level": "级别", "Revoke": "撤销", "Nobody else has access.": "目前没有其他人可访问。",
  "Forward incoming mail to": "将新邮件转发到", "While forwarding is on, new mail skips this mailbox.": "开启转发后，新邮件不会进入此邮箱。",
  ...
  "member": "成员", "Time": "时间",
  "Delivers to": "投递到", "Targets": "目标", "Local part": "@ 前的部分", "Any address at this domain that has no mailbox": "此域名下所有没有对应邮箱的地址",
  "Everything starting with this prefix": "以此前缀开头的所有地址", "Delivers to mailbox": "投递到邮箱", "Note": "备注",
  "Delete address {a}?": "删除地址 {a}？", "Address created.": "地址已创建。", "Address updated.": "地址已更新。",
  "Add group": "添加群组", "Description": "描述", "Distribution address": "分发地址", "Mail sent to this address reaches every member.": "发到这个地址的邮件会送达所有成员。",
  ...
  "Removing a domain deletes every mailbox and rule on it from Purelymail. Type the domain name to confirm.": "移除域名会从 Purelymail 删除其下所有邮箱和规则。输入域名以确认。",
  ...
  "Sync imports domains, mailboxes and routing rules that were changed outside Mailhearth.": "同步会导入在 Mailhearth 之外修改的域名、邮箱和路由规则。",
